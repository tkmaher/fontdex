...
qualifiers = [
    "light", "regular", "medium", "semibold", "bold", "extrabold", "black", "demibold", "extralight", "thin", "ultralight", "heavy", "book", "italic", "oblique", "condensed", "narrow", "tight", "free", "web"
]
...
def sanitize(font):
    ...
    if ';' in font or '/' in font or ':' in font or '(' in font or ')' in font:
